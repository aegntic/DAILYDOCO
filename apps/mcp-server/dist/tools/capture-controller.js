...
export class CaptureController extends EventEmitter {
    ...
    async startCapture(args) {
        const { project_path, quality, capture_audio, ai_optimization, privacy_filters, } = args;
    ...
    async startScreenCapture(quality, audio) {
